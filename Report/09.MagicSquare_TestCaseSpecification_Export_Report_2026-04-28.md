# Magic Square 4×4 — 테스트 케이스 명세 내보내기 보고서

| 항목 | 값 |
|------|-----|
| 보고서 ID | 09.MagicSquare_TestCaseSpecification_Export |
| 작성일 | 2026-04-28 |
| 유형 | PRD 정합 테스트 케이스 표(TC-MS-*)·환경·전제·기준·절차 Report 아카이브 |
| 주 소스 (완료·검증 조건) | [`../docs/PRD_MagicSquare_4x4_DualTrack_TDD.md`](../docs/PRD_MagicSquare_4x4_DualTrack_TDD.md) |
| 보조 (에픽·여정) | [`05.MagicSquare_UserJourney_EpicToTechnical_Report_2026-04-27.md`](05.MagicSquare_UserJourney_EpicToTechnical_Report_2026-04-27.md) |
| 원본 (docs 동기화) | [`../docs/TestCaseSpecification_MagicSquare_4x4.md`](../docs/TestCaseSpecification_MagicSquare_4x4.md) |
| 관련 내보내기 | [`06.MagicSquare_PRD_DualTrack_Export_Report_2026-04-27.md`](06.MagicSquare_PRD_DualTrack_Export_Report_2026-04-27.md) (PRD), [`07.MagicSquare_README_ProjectExport_Report_2026-04-28.md`](07.MagicSquare_README_ProjectExport_Report_2026-04-28.md) (README) |

---

## 1. 목적

- PRD **§11** (TC-01~08, TD-01~07) 및 **FR-01~05**·**AC**와 정합된 **시나리오·단위 테스트 케이스 표**를 Report 폴더에 **고정 사본**으로 둔다.  
- 실습/강의용 10열 표(TC ID, 기능 분류, Given/When/Then, 예상 결과, P1~P3, 비고)와 **테스트환경·전제·성공·실패·특별 절차**를 한 문서에서 추적한다.  
- **정본(SSOT)은 항상** `docs/PRD_...` 및 **`docs/TestCaseSpecification_MagicSquare_4x4.md`** — 내용이 갱신되면 본 Report도 동일하게 맞춘 뒤 재내보내는 것을 권장한다.
...
| 항목 | 내용 |
|------|------|
| **포함 범위** | TC-MS-A-001~C-002, `pytest`·NFR-01, TD-01~07 매핑 |
| **버전** | TestCase spec v1.0 (문서 내부 표기와 동일) |
| **차기 작업** | `docs/.../TestCaseSpecification_...` 수정 시 **본 파일 본문(§3) 동기화** 또는 “원본 링크만 유지 + §3 요약” 정책 팀 합의 |

---

## 3. 본문: 테스트 케이스 명세 (docs와 동일)

*아래는 [`../docs/TestCaseSpecification_MagicSquare_4x4.md`](../docs/TestCaseSpecification_MagicSquare_4x4.md)와 동일하다. Report·오프라인 전달용 아카이브다.*
...
*행렬·오류코드·`int[6]`·예외명은* [`../docs/PRD_MagicSquare_4x4_DualTrack_TDD.md`](../docs/PRD_MagicSquare_4x4_DualTrack_TDD.md) *가 정본이며, 본 표의 TC-MS-xxx ID는 문서·강의용 권고명이다. PRD `TC-01`~`TC-08`과 1:1이 아닌 점(세분)은 비고·PRD 열로 추적한다.*
